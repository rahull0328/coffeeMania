        ...
        <div class="row">
        	<div class="col-md-6 mb-5 pb-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-1.jpg') ?>);"></div>
        			<div class="desc pl-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-3.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-4.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        	...
        	<div class="col-md-6 mb-5 pb-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-5.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-6.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-7.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dish-8.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        	...
        	<div class="col-md-6">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dessert-1.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Cornish - Mackerel</span></h3>
	        				<span class="price">$20.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dessert-2.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Roasted Steak</span></h3>
	        				<span class="price">$29.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dessert-3.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Seasonal Soup</span></h3>
	        				<span class="price">$20.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/dessert-4.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Chicken Curry</span></h3>
	        				<span class="price">$20.00</span>
        	...
        	<div class="col-md-6">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/drink-5.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Sea Trout</span></h3>
	        				<span class="price">$49.91</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/drink-6.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Roasted Beef</span></h3>
	        				<span class="price">$20.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/drink-7.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Butter Fried Chicken</span></h3>
	        				<span class="price">$20.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?= urlOf('assets/images/drink-8.jpg') ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Chiken Filet</span></h3>
	        				<span class="price">$20.00</span>
